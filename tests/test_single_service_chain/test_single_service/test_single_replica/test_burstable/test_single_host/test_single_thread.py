...
class Test1SFC1S1R1T1HBR:  # BR = burstable
    ...
    def test_all_traffic_types_all_topologies(self, traff_proto_name, topo_name, expected_avg_lats_obj, ras, filepath):
        if topo_name == 'tau_1host_1core_host_scenario' and \
                traff_proto_name == '3batchps_60sec_2paralleluser' and \
                filepath == 'expected_results/single_thread_expected_results_100.json':
